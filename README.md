...
Used free API to access NBA related data for all the NBA games. Games are updated as they complete, Live(ish) game stats are available (updated every ~10 minutes), and the data goes back as far as the 1979 NBA season🏀🛠️
